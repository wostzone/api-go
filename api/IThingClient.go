...
type IThingClient interface {
	...
	PublishTD(thingID string, td interface{}) error
	...
	PublishPropertyValues(thingID string, values interface{}) error
	...
	PublishEvent(thingID string, event interface{}) error
	...
	SubscribeToAction(thingID string, handler func(thingID string, action interface{}, senderID string))
	...
	//     senderID is the authenticated client ID of the sender
	SubscribeToConfig(thingID string, handler func(thingID string, config interface{}, senderID string))
}
